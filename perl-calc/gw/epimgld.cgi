...
$magick_handler->Composite( image => $monster_handler_back,  compose => 'over', gravity => 'Center', y => "-20" );
$magick_handler->Composite( image => $monster_handler_front, compose => 'over', gravity => 'Center', y => "+10" );
